...
import { THEMES, DEFAULT_ACCENTS, NEBULA_ACCENTS, CATPPUCIN_ACCENTS, THEME_VARS } from './Theme';
...
export default function Settings() {
  ...
  // Run once on mount to apply saved styles to the document
  useEffect(() => {
    applyTheme(theme);
    applyAccent(accent);
    if (fontSize) {
              ...
              <div className="settings-tab active">
                ...
                <div className="settings-group">
                  ...
                  <div className="accent-grid">
                    {(theme === 'nebula' ? NEBULA_ACCENTS : theme === 'catppuccin' ? CATPPUCIN_ACCENTS : DEFAULT_ACCENTS).map(a => (
